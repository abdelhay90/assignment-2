...
import fetchGistSaga from './sagas/fetch-gist-saga'
import fetchGistsSaga from './sagas/fetch-gists-saga'
...
export default function (history, defaultState = {}) {
     ...
     */
    sagaMiddleware.run(fetchGistSaga);
    sagaMiddleware.run(fetchGistsSaga);
